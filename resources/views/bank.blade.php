...
@section('mainContent')
    <div
        ...
        <form class="space-y-6" method="post" action="{{ route('bank_data_submit') }}">
            @csrf
            <h5 class="text-xl font-medium text-gray-900 dark:text-white">Fill The Bank Details</h5>
            <div class="flex items-center p-4 mb-4 text-sm text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 dark:border-yellow-800"
                ...
                <div>
                    <span class="font-medium">Note:</span> Enter Bank Detailes As Per Aadhar.
                </div>
            </div>
            ...
            <div>
                <label for="ifsc" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">IFSC
                    Code</label>
                <input type="ifsc" name="ifsc" id="ifsc"
                    ...
                    placeholder="SBIN002712" value="{{ old('ifsc') }}" required />
            </div>
            <div>
                <label for="account_number" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Account
                    Number</label>
                <input type="account_number" name="account_number" id="account_number"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
